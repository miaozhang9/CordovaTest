...
+ (CDVIntentAndNavigationFilterValue) filterUrl:(NSURL*)url intentsWhitelist:(QHWhitelist*)intentsWhitelist navigationsWhitelist:(QHWhitelist*)navigationsWhitelist
{
